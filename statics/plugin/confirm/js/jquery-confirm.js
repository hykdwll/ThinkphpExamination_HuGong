...
(function(factory){
    ...
    w.Jconfirm.prototype = {
        ...
        _buildHTML: function(){
			...
			var icons = {};
			icons['info'] = "text-primary fa fa-exclamation-circle";
			icons['fail'] = "text-danger fa fa-times-circle";
			icons['warning'] = 'text-warning orange fa fa-exclamation-triangle';
			icons['error'] = 'text-danger fa fa-times-circle';
			icons['success'] = 'text-success fa fa-check-circle';
			var titles = {};
			titles['info'] = "信息";
			titles['fail'] = "失败";
			titles['warning'] = '警告';
			...
			if(icons[this.type]){
				this.title = titles[this.type] + this.title;
			}
			if(icons[this.type]){
